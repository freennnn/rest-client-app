...
export const Header = () => {
    return <header className='flex align-center sticky top-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-3 px-6'>
        <div id={styles.logo}>
        ...
        <div className={styles.action}>
            <div className='w-10 flex justify-center align-center p-2 border-1 bg-white text-black dark:bg-background dark:text-white hover:scale-110 transition-transform duration-200'>
                <Image src={lightMode} alt='mode' width={16} height={16}/>
            </div>
            <CustomSelect icon={langLogo} options={[
                {
                    label: 'Eng',
                    value: 'eng'
                }, 
